use super::{Function, HighLevelILError, Instruction, Intrinsic};
use crate::rc::Ref;
...
pub enum Operation<'func> {
    Nop {},
    Block {
        body: Vec<Instruction<'func>>,
    },
    If {
        condition: Instruction<'func>,
        true_: Instruction<'func>,
        false_: Instruction<'func>,
    },
    While {
        condition: Instruction<'func>,
        body: Instruction<'func>,
    },
    WhileSsa {
        condition_phi: Instruction<'func>,
        condition: Instruction<'func>,
        body: Instruction<'func>,
    },
    DoWhile {
    ...
    For {
        init: Instruction<'func>,
        condition: Instruction<'func>,
        update: Instruction<'func>,
        body: Instruction<'func>,
    },
    ForSsa {
        init: Instruction<'func>,
    ...
    Switch {
        condition: Instruction<'func>,
        default: Instruction<'func>,
        cases: Vec<Instruction<'func>>,
    },
    Case {
        values: Vec<Instruction<'func>>,
        body: Instruction<'func>,
    },
    Break {},
    Continue {},
    Jump {
        dest: Instruction<'func>,
    },
    Ret {
        src: Vec<Instruction<'func>>,
    },
    Noret {},
    Unreachable {},
    Goto {
    ...
    Split {
        high: Instruction<'func>,
        low: Instruction<'func>,
    },
    Deref {
        src: Instruction<'func>,
    },
    ...
    Add {
        left: Instruction<'func>,
        right: Instruction<'func>,
    },
    Adc {
        left: Instruction<'func>,
        right: Instruction<'func>,
        carry: Instruction<'func>,
    },
    Sub {
        left: Instruction<'func>,
        right: Instruction<'func>,
...
impl<'func> Operation<'func> {
    pub fn from_instr(
        ...
        macro_rules! expr_list {
            ($operand_index:literal) => {{
                ...
                unsafe {
                    ...
                    let operands = BNHighLevelILGetOperandList(
                        func.handle,
                        expr_index,
                        $operand_index,
                        &mut count,
        ...
        Ok(match instr.operation {
            BNHighLevelILOperation::HLIL_NOP => Operation::Nop {},
            ...
            BNHighLevelILOperation::HLIL_DO_WHILE => {
                let body = expr!(0);
                let condition = expr!(1);
                Operation::DoWhile { body, condition }
            }
            ...
            BNHighLevelILOperation::HLIL_CASE => {
                ...
                let body = expr!(2);
                Operation::Case { values, body }
            }
            BNHighLevelILOperation::HLIL_BREAK => Operation::Break {},
            BNHighLevelILOperation::HLIL_CONTINUE => Operation::Continue {},
            ...
            BNHighLevelILOperation::HLIL_NORET => Operation::Noret {},
            BNHighLevelILOperation::HLIL_UNREACHABLE => Operation::Unreachable {},
            ...
            BNHighLevelILOperation::HLIL_ARRAY_INDEX => {
                let src = expr!(0);
                let index = expr!(1);
                Operation::ArrayIndex { src, index }
            }
            ...
            BNHighLevelILOperation::HLIL_DEREF_SSA => {
                let src = expr!(0);
                let src_memory = int!(1);
                Operation::DerefSsa { src, src_memory }
            }
            ...
            BNHighLevelILOperation::HLIL_BP => Operation::Bp {},
            ...
            BNHighLevelILOperation::HLIL_INTRINSIC => {
                ...
                let params = expr_list!(1);
                Operation::Intrinsic { intrinsic, params }
            }
            ...
            BNHighLevelILOperation::HLIL_UNDEF => Operation::Undef {},
            BNHighLevelILOperation::HLIL_UNIMPL => Operation::Unimpl {},
